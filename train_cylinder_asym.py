...
def main(args):
    ...
    if os.path.exists(model_load_path):
        print('found existing model, loading existing model!')
    ...
    train_dataset_loader, val_dataset_loader = data_builder.build(dataset_config,
                                                                  ...
                                                                  grid_size=grid_size)
    print('len of val_dataset_load is: ', len(val_dataset_loader))
    print('len of train_dataset_load is: ', len(train_dataset_loader))
