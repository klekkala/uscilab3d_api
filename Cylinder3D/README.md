...
Link1: https://paperswithcode.com/sota/3d-semantic-segmentation-on-semantickitti
Link2: https://github.com/xinge008/Cylinder3D (github using)
Link3： https://github.com/xinge008/Cylinder3D/issues/97
Link5: http://www.semantic-kitti.org/dataset.html#download (dataset of semantic-kitti)
link6: https://github.com/traveller59/spconv

Introduction
We are doing no.11 performance on the website of kitti semantic (link 1)

1.first step install requirement
follow link6 to install spconv
execute following command
pip install spconv-cu120
pip install pyyaml
pip install torch-scatter -f https://data.pyg.org/whl/torch-2.2.0+cu121html
https://github.com/rusty1s/pytorch_scatter

-
problem
if only using “pip3 install torch-scatter” will produce error
...
-
Problem
AttributeError: module 'spconv' has no attribute 
Solution
Follow link2, the reason is cuda 12 has to use a certain version of spconv
-
Problem
Cuda space out
Solution
Change batch size from 2 to 1 in semantickitti.yaml file under config.

-
Question
Importerror: cannot import name ‘TensorOpParams’ from ‘cumm.gemm.algospec.core’
solution
https://blog.csdn.net/weixin_44013732/article/details/133203485
reason
your cumm version is too high
more information
check link https://github.com/traveller59/spconv/blob/master/docs/USAGE.md to see update in spconv
