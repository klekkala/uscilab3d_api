...
#parser.add_argument('--gpu_id', type=list,default=[0,1], help='use cpu only') # this line is comment because we wanna to use 1 gpu only
...
parser.add_argument('--dataset_path',default = '/home/student/3duNet/fixed_data',help='fixed trainset root path')
parser.add_argument('--test_data_path',default = '/home/student/3duNet/raw_dataset/test',help='Testset path')
parser.add_argument('--save',default='ResUNet',help='save path of trained model')
#parser.add_argument('--batch_size', type=list, default=2,help='batch size of trainset') # our gpu sucks, change default to 1
